...
class Dictionary:
    ...
    @_typing.overload
    def getDistanceToId(self, onlyCellPixelRatio: cv2.typing.MatLike, id: int, allRotations: bool, validBitIdThreshold: float) -> int: ...
    @_typing.overload
    def getDistanceToId(self, onlyCellPixelRatio: cv2.UMat, id: int, allRotations: bool, validBitIdThreshold: float) -> int: ...
